...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0" style="font-size: 17px">
            ...
            <li><a href="/reviews" class="nav-link px-2 link-secondary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Reviews</font></font></a></li>
                ...
                <?php foreach ($getComments as $res):?>
                    <li class="basket__box">
                        <div class="basket__flex">
                            <h1><?php $id = $res['id_product']; $query = "SELECT name_product FROM `product` WHERE id = ".$id;
                                $resultName = select($query); for($i = 0; $i < count($resultName); $i++){echo $resultName[$i]['name_product'];} ?></h1>
                        ...
                        <ul class="list" id="list<?php echo $res['id']?>">
                            <li class="list-info">
                                ...
                                <ul>
                                    <li><span>Comments:</span><?php echo $res['comments']?></li>
