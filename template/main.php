...
<main class="main">
        ...
        <div class="container top-slider__container">
            <div class="top-slider__inner">
                <div class="top-slider__item">
                    ...
                    <img class="top-slider__img" src="/static/images/slider/foto.png" alt="slide image">
                </div>
        ...
        <div class="categories-info__inner">
            <div class="container">
                ...
                <div class="categories">
                    ...
                    <div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo tempor
                        ut
                        labore et dolore aliqua.</div>
                </div>
                <div class="categories__items">
                    <div class="categories__item"
                         style="background-image: url('/static/images/content/categories/jewellry.jpg');">
                    ...
                    <div class="categories__item"
                         style="background-image: url('/static/images/content/categories/accessories.jpg');">
                        <p class="categories__item-subtitle">
                            New Arrival
                        </p>
                        <h4 class="categories__item-title">
                    ...
                    <div class="categories__item"
                         style="background-image: url('/static/images/content/categories/fashion.jpg');">
                        <p class="categories__item-subtitle">
                            Trending Now
                        </p>
                        <h4 class="categories__item-title">
                    ...
                    <div class="categories__item"
                         style="background-image: url('/static/images/content/categories/girl-fashion.jpg');">
                        <p class="categories__item-subtitle">
                            Hot Collection
                        </p>
                        <h4 class="categories__item-title">
    ...
    <section class="video-fashion">
        <div class="container">
            <div class="video-fashion__inner">
                <div class="video-fashion__popup" style="background-image: url('/static/images/video-fashion.jpg');">
                    <a class="video-fashion__play" data-fancybox href="https://www.youtube.com/watch?v=_sI_Ps7JSEk">
                        <img src="/static/images/icons/play-btn.svg" alt="video play button">
                    </a>
                </div>
                <div class="video-fashion__content">
                    ...
                    <div class="video-fashion__text">Lorem ipsum dolor sit amet, consectetur apiscing elit, sed do
    ...
    <section class="product">
        <div class="container">
            ...
            <div class="product__items">
                ...
                <div class="product-item">
                    <div class="product-item__img-box">
                        <img src="/static/images/product/1.jpg" alt="product" class="product-item__images">
                ...
                <div class="product-item product-item--sale">
                    <div class="product-item__img-box">
                        <img src="/static/images/product/2.jpg" alt="product" class="product-item__images">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg width="19px" height="20px">
                                    <path fill-rule="evenodd" fill="rgb(41, 40, 45)"
                    ...
                    <div class="star" data-rateyo-rating="4">
                ...
                <div class="product-item product-item--sale">
                    <div class="product-item__img-box">
                        <img src="/static/images/product/3.jpg" alt="product" class="product-item__images">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg width="19px" height="20px">
                                    <path fill-rule="evenodd" fill="rgb(41, 40, 45)"
                    ...
                    <div class="star" data-rateyo-rating="4.5">
                ...
                <div class="product-item">
                    <div class="product-item__img-box">
                        <img src="/static/images/product/4.jpg" alt="product" class="product-item__images">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg width="19px" height="20px">
                                    <path fill-rule="evenodd" fill="rgb(41, 40, 45)"
                    ...
                    <div class="star" data-rateyo-rating="3">
                ...
                <div class="product-item product-item--sale">
                    <div class="product-item__img-box">
                        <img src="/static/images/product/5.jpg" alt="product" class="product-item__images">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg width="19px" height="20px">
                                    <path fill-rule="evenodd" fill="rgb(41, 40, 45)"
                    ...
                    <div class="star" data-rateyo-rating="3.5">
                ...
                <div class="product-item">
                    <div class="product-item__img-box">
                        <img src="/static/images/product/6.jpg" alt="product" class="product-item__images">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg width="19px" height="20px">
                                    <path fill-rule="evenodd" fill="rgb(41, 40, 45)"
                    ...
                    <div class="star" data-rateyo-rating="2">
            ...
            <a class="product__link" href="/shop">LOAD MORE</a>
        </div>
    </section>
    ...
    <div class="promo">
        <div class="container">
            <div class="promo__inner">
                ...
                <div class="promo__clock" data-time="'2022-05-30'">
    ...
    <div class="partners">
        <div class="container">
            <ul class="partners__list">
                <li class="partners__item"><img src="/static/images/partners/1.png" alt="partner logo"></li>
                <li class="partners__item"><img src="/static/images/partners/2.png" alt="pertner logo"></li>
                <li class="partners__item"><img src="/static/images/partners/3.png" alt="partner logo"></li>
                <li class="partners__item"><img src="/static/images/partners/4.png" alt="partner logo"></li>
                <li class="partners__item"><img src="/static/images/partners/5.png" alt="partner logo"></li>
                <li class="partners__item"><img src="/static/images/partners/6.png" alt="partner logo"></li>
            </ul>
        </div>
    </div>
            ...
            <div class="blog__items">
                ...
                <div class="blog__item">
                    <a class="blog__item-imglink" href="#">
                        <img src="/static/images/blog/1.jpg" alt="blog img">
                    </a>
                ...
                <div class="blog__item">
                    <a class="blog__item-imglink" href="#">
                        <img src="/static/images/blog/2.jpg" alt="blog img">
                    </a>
                    <div class="blog__item-box">
                        <div class="blog__item-info">
                            <a class="blog__item-author" href="#">By Admin</a>
                ...
                <div class="blog__item">
                    <a class="blog__item-imglink" href="#">
                        <img src="/static/images/blog/3.jpg" alt="blog img">
                    </a>
                    <div class="blog__item-box">
                        <div class="blog__item-info">
                            <a class="blog__item-author" href="#">By Admin</a>
