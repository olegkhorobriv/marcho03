<div class="product-item">
    <div class="product-item__img-box">
        <img src="/static/images/product/<?php echo $row['img1'] ?>" alt="product" class="product-item__/static/images">
        <div class="product-item__link-box">

            <a class="product-item__link product-item__link--line" href="/products/<?php echo $row['id'] ?>">
    ...
    <div class="product-item__wrapper-box">
        <div class="product-item__box">
            ...
            <div class="product-item__price">
                <div class="product-item__new-price"><?php echo $row['price'] ?>$</div>
                <div class="product-item__old-price"><?php if ($row['discount'] != null) {
                        echo discount($row['price'], $row['discount']) . '$';
                    } ?></div>
            </div>
        </div>
        <div class="product-item__content-box">
            <p class="product-item__text"><?php echo mb_strimwidth($row['description'], 0, 250, '......') ?>
            </p>
