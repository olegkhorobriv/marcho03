    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="footer-top__item footer-top__item-form">
                ...
                <form class="footer-top__form" action="#">
                    <input class="footer-top__form-input" type="email" placeholder="Your email addres" required>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-bottom__accept">
                We Accept
                <img class="footer-bottom__accept-img" src="/static/images/icons/mastercard.png"
                     alt="we accept mastercard">
                <img class="footer-bottom__accept-img" src="/static/images/icons/visa.png" alt="we accept visa">
                <img class="footer-bottom__accept-img" src="/static/images/icons/paypal.png" alt="we accept Pay Pal">
            </div>
        </div>
    </div>
